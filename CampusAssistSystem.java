...
public class CampusAssistSystem {
    ...
    private void loadHardcodedData() {
        ...
        Student student1 = new Student("S1001", "Alice Wonderland");
        Student student2 = new Student("S1002", "Bob The Builder");
        students.put(student1.getStudentId(), student1);
        students.put(student2.getStudentId(), student2);

        // Create some admin users
        Admin admin1 = new Admin("A1001", "John Smith", "john.smith@university.edu", "Support Staff");
        Admin admin2 = new Admin("A1002", "Jane Doe", "jane.doe@university.edu", "System Admin");
    ...
    public Appointment requestAppointment(Student student, Category category, LocalDateTime dateTime) {
        if (student == null || !students.containsKey(student.getStudentId())) {
            System.out.println("Error: Cannot schedule appointment for unknown student.");
            return null;
        }
